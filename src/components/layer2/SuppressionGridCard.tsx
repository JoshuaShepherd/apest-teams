      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs">
        ...
        <div className="p-5 rounded-xl bg-emerald-50/60 border border-emerald-200 space-y-3">
          <div className="flex items-center justify-between">
            <span className="font-bold text-emerald-900 text-sm">Dominant & Empowered</span>
        ...
        <div className="p-5 rounded-xl bg-rose-50/60 border border-rose-200 space-y-3">
          <div className="flex items-center justify-between">
            <span className="font-bold text-rose-900 text-sm">The Isolated Catalyst</span>
            <AlertOctagon className="w-4 h-4 text-rose-700" />
          </div>
          <div className="font-semibold text-ink-primary">Apostle (Marcus Webb)</div>
          <p className="text-ink-secondary leading-relaxed">
        ...
        <div className="p-5 rounded-xl bg-amber-50/60 border border-amber-200 space-y-3">
          <div className="flex items-center justify-between">
            <span className="font-bold text-amber-900 text-sm">Structurally Suppressed</span>
            <UserX className="w-4 h-4 text-amber-700" />
          </div>
          <div className="font-semibold text-ink-primary">Evangelist (Sofia Reyes)</div>
          <p className="text-ink-secondary leading-relaxed">
        ...
        <div className="p-5 rounded-xl bg-indigo-50/60 border border-indigo-200 space-y-3">
          <div className="flex items-center justify-between">
            <span className="font-bold text-indigo-900 text-sm">Present but Pigeonholed</span>
